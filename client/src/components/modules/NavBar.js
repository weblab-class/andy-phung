        ...
        <div className="flex flex-row mb-[7px]">
            ...
            <div className="flex flex-col">
                ...
                {props.editing[2] ? (
                        ...
                        <svg onClick={() => {
                            props.setEditing([props.editing[0], props.editing[1], !props.editing[2]]);
                        }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-[18px] h-[18px] hover:opacity-65 hover:cursor-pointer">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                        </svg>
                    </>
    ...
    return (
        <div className={`justify-between flex flex-col ${sidebarClass}`}>
            <div className="">
                ...
                <div onClick={() => {props.closeModal(); props.setModalId("profile"); props.openModal(profileModal);}} className="flex items-center pt-[10px] pb-[10px] pl-[20px] cursor-pointer hover:bg-[#DBA568]">
                ...
                <div onClick={() => {props.closeModal(); props.setModalId("achievements"); props.openModal(achievementsModal);}} className="flex items-center pt-[10px] pb-[10px] pl-[20px] cursor-pointer hover:bg-[#DBA568]">
                ...
                <div onClick={() => {props.closeModal(); props.setModalId("settings"); props.openModal(settingsModal);}} className="flex items-center pt-[10px] pb-[10px] pl-[20px] cursor-pointer hover:bg-[#DBA568]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#694F31" className="w-[60px] h-[60px]">
